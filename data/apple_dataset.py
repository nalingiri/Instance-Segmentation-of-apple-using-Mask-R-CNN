...
class AppleDataset(object):
    ...
    def __getitem__(self, idx):
        ...
        #mask = Image.open(mask_path)#.convert('LA')     # Each color of mask corresponds to a different instance with 0 being the background
        # 1.Convert('LA') is used for Color to Gray image
        # 2.Originally it was not there.
